...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +01960940461")
	subprocess.check_output(["am", "start", "https://wa.me/+01960940461"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Nobita-69/NOBITA-XD69/blob/main/Approval').text
			if basesplit in plr:
				key = basesplit
